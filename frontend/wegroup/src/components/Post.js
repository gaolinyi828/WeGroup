...
class Post extends Component {
            ...
            if (post.interested.length >0) {
                return (<ListGroup horizontal>
                    {post.interested.map((person, index)=> (
                        ...
                        <span href='' style={{width: "35px", height: "auto"}}>{person}</span>
                        </ListGroup.Item>
                    ))}
                </ListGroup>);
            } else {
    ...
    renderInterestButton() {
        if (this.props.post.interested && this.props.post.interested.length) {
        ...
        return (
            <div>
                <Jumbotron fluid style={{width: '90%', margin: 'auto', minHeight: "150px"}}>
                    ...
                    <p>
                        <span>Posted by: {this.state.postOwner}</span>
                        <span>&nbsp; &nbsp; &nbsp;</span>
