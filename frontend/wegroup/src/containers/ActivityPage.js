...
class ActivityPage extends Component {
    ...
    componentDidMount() {
        this.tagService.getAllTags().then(res => res.json()).then(res => {
            this.setState({...this.state, tags: res});
        })
    }
                ...
                <Container fluid style={{padding: 0}}>
                    <div>
                        ...
                        <div className="main-page">
                            <Tab.Container id="left-tabs-example" defaultActiveKey="first" onSelect={(index) => this.onSelect(index)}>
                                <Row>
                                    ...
                                    <Col sm={10} style={{backgroundColor: '#f3f2f1'}}>
                                        <Tab.Content>
                                            {this.renderTagContents()}
                                        </Tab.Content>
                                    </Col>
                                </Row>
                            </Tab.Container>
